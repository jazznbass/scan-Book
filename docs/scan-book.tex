...
\includegraphics{scan-book_files/figure-latex/unnamed-chunk-41-1.pdf}
...
\emph{Note: You need specific knowledge on how to create functions in R and on data structures to follow all aspects this section.}
...
\caption{\label{tab:unnamed-chunk-74}Single case data frame with 3 cases}
...
\caption{\label{tab:unnamed-chunk-77}Piecewise-regression model predicting variable 'values'}
\begin{threeparttable}
\begin{tabular}[t]{lrrrrrrr}
\toprule
\multicolumn{2}{c}{ } & \multicolumn{2}{c}{CI(95\%)} & \multicolumn{4}{c}{ } \\
