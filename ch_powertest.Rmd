...
print_table(tab, "Core arguments of the design function")
...
Then you have to choose the statistical method. The `power_test` function applies three methods by default: *plm*, *randomization test*, and *Tau U*.
...
... and what about our fast-glm function?
...
... it is more that two times faster!
