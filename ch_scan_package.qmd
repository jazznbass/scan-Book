...
The current stable release is version `0.62.0`. Please refer to the *Software Reference* section to see which version of *scan* was used to create this book, and make sure you have this or a newer version installed.
...
out <- tribble(
  ...
  "export", "Creates html or latex tables from the output of various scan functions", "Stable",
...
out <- tribble(
  ...
  "between_smd", "Between case standrdized mean difference", "Stable",
...
out <- tribble(
  ...
  "rescale", "Standardizes variables across cases", "Stable",
