...
In a more complex example, we only want to keep values less than 60 when they are in phase A, or values equal to or greater than 60 when they are in phase B:
