...
dat <- random_scdf(design(1, level = 0.4,phase_design = list(A = 8, B = 12)), round = 0, seed = 1232, random.names = "male")
...
dat <- random_scdf(design(1, phase_design = list(A = 10, B = 15), level = 0.4),round = 0, seed = 9871, random.names = "female")
