...
kable(res, align = "c") %>%
  kable_classic(full_width = FALSE) %>%
  add_header_above(c(" " = 2, "level" = 2, "slope" = 2,"level" = 2, "slope" = 2)) %>%
  add_header_above(c(" " = 2, "contrast\nfirst" = 4, "contrast\npreceeding" = 4))
```
...
It is important to keep in mind, that an overly complex model might have negative effects on the test power of an analyzes (that is, the probability of detecting a actually existing effect is diminished) see [see @wilbert2022]
