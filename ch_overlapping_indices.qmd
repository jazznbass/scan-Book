...
- $\hat{\beta}_1$ is the estimated fixed effect of the phase (i.e., mean differecne between phase A and B),
- $\hat{\sigma}^2_\varepsilon$ is the within-case residual variance (level-1),
