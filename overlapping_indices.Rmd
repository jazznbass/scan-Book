...
Overlap measures refer to a comparison of two phases within a single-case data-set. By default, overlapSC compares a Phase A to a Phase B. The `phases` argument is needed if the phases of the *scdf* do not include phases named A and B or a comparison between other phases in wanted.  
...
```{r echo = FALSE, fig.width = 4, fig.height = 3,fig.cap = "Illustration of PET. PET is 66.7% as 10 out of 15 datapoints of phase B are higher than the median of phase A."}
...
The `rciSC function computes three indices of reliable change [@wise_methods_2004] and corresponding descriptive statistics.
